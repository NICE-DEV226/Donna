...
/** Logo Google officiel, en pastille blanche pour rester lisible sur le burgundy. */
@Component({
  selector: 'google-mark',
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: { class: 'inline-flex shrink-0', '[attr.aria-hidden]': 'true' },
  template: `
    <span
      class="inline-flex items-center justify-center rounded-full bg-white"
