...
class OAuthAccount(Base):
    ...
    # Jetons OAuth chiffrés (Fernet, voir services/crypto.py) — nécessaires
    # pour appeler l'API du provider au nom de l'utilisateur (ex: Gmail,
    # Calendar), distincts des jetons de session xauth (identité seule).
